...
[![ManagicAI CI Pipeline](https://github.com/your-username/work-ai/actions/workflows/ci.yml/badge.svg)](https://github.com)
[![License: MIT](https://img.shields.io/badge/License-MIT-purple.svg)](https://opensource.org/licenses/MIT)
[![CognoDB](https://img.shields.io/badge/Database-CognoDB%20Cloud%20(Bolt%205.4)-blue.svg)](https://console.cognodb.com)
[![Next.js 15](https://img.shields.io/badge/Next.js-15.1%20App%20Router-black.svg)](https://nextjs.org)
...
### 1. AI Conflict Radar & Shield Enforcements
...
### 2. Multi-Hop Action Stunt Precedence to Cannes VIP Gala (2+ Hops)
...
Finds the exact contractual and operational relationship path between any two nodes in CognoDB:
```cypher
...
Calculates the cascading slip across call-sheets, meetings, and festival itineraries if a shoot date slips:
```cypher
...
## 5. Enterprise 4-Tier Backend Architecture
...
Wipes and populates CognoDB Cloud with **64 nodes and 114 multi-hop relationships**:
```bash
npm run seed
```

### 5. Run Automated Tests & Local CI Verification
```bash
# Run unit & integration test suites
npm test

# Run complete CI verification (Typecheck -> 19 Tests -> Live Queries -> Next.js Build)
npm run ci:check
```
